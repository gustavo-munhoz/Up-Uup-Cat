...
class CucumberEntity: GKEntity {
    ...
    func updateSpeedAndAcceleration(basedOnProgress progress: CGFloat, isCatPumpedUp: Bool = false) {
        if isCatPumpedUp {
            agentComponent.agent.maxSpeed = 4000
            agentComponent.agent.maxAcceleration = 2000
